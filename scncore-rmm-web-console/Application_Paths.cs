...
namespace ScncoreRmmWebConsole
{
    public class Application_Paths
    {
        //public static string logs_dir = @"C:\ProgramData\0x101 Cyber Security\scncore-rmm\Web Console\Logs";
        public static string logs_dir = Path.Combine(GetBasePath(), "scncore", "scncore-rmm", "Web Console", "Logs");
        ...
        public static string scncore_rmm_logo_svg_path = Path.Combine(Environment.CurrentDirectory, "wwwroot", "media", "images", "scncore-rmm-logo.svg");
        public static string scncore_rmm_logo_png_path = Path.Combine(Environment.CurrentDirectory, "wwwroot", "media", "images", "scncore-rmm-logo.png");
        ...
        //public static string debug_txt_path = @"C:\ProgramData\0x101 Cyber Security\scncore-rmm\Web Console\debug.txt";
