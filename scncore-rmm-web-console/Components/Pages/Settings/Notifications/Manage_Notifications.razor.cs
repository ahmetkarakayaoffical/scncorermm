...
namespace scncore_rmm_web_console.Components.Pages.Settings.Notifications
{
    ...
    {            
        ...
        private async Task Send_Mail(string mail_address)
        {
            ...
            string result = await Classes.Helper.Notifications.Smtp.Send_Mail(mail_address, "scncore-rmm - Test Alert", "Test.");
        ...
        private string microsoft_teams_notifications_selectedRowContent = ""; // Hier wird der Inhalt der ausgew�hlten Zeile gespeichert
        ...
        private async Task Send_Microsoft_Teams_Message(string id, string connector_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Microsoft_Teams.Send_Message(id, "scncore-rmm Alert: Test.<br>Connector Name: " + connector_name);
        ...
        private async Task Send_Telegram_Message(string id, string bot_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Telegram.Send_Message(id, "scncore-rmm Alert: Test.\nBot Name: " + bot_name);
        ...
        private string ntfy_sh_notifications_selectedRowContent = ""; // Hier wird der Inhalt der ausgew�hlten Zeile gespeichert
        ...
        private async Task Send_Ntfy_sh_Message(string id, string topic_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Ntfy_sh.Send_Message(id, "scncore-rmm Alert: Test.\nTopic Name: " + topic_name);
