namespace ScncoreRmmWebConsole
{
    ...
    {
        public static string db_version = "2.5.2.5";
        public static string web_console_version = "Celestial-Vortex (2.5.2.5)";
        public static string Local_Encryption_Key = "01234567890123456789012345678901";

        //OSSCH_START b7b2f4c5-beec-42e4-83b4-1cdbbe5d1119 //OSSCH_END
