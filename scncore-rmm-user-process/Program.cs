...
using scncore_rmm_user_process.Helper.Keyboard;
using scncore_rmm_user_process.Windows.Helper;
using scncore_rmm_user_process.Windows.Mouse;
using scncore_rmm_user_process.Windows.ScreenControl;
using WindowsInput;
...
class Program
{
    static async Task Main(string[] args)
    {
        try
        {
            Console.WriteLine("Starting scncore-rmm User Process...");
