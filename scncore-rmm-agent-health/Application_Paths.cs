...
namespace scncore_rmm_agent_health
{
    internal class Application_Paths
    {
        ...
        public static string c_temp_scncore_logs_dir = Path.Combine(GetTempPath(), "scncore-rmm", "installer", "logs");
        public static string c_temp_scncore_installer_dir = Path.Combine(GetTempPath(), "scncore-rmm", "installer");
        public static string c_temp_scncore_installer_path = Path.Combine(c_temp_scncore_installer_dir, OperatingSystem.IsWindows() ? "scncore-rmm-agent-installer.exe" : "scncore-rmm-agent-installer");
        ...
        public static string program_data = Path.Combine(GetBasePath_CommonApplicationData(), "scncore", "scncore-rmm", "Health Agent");
        public static string program_data_logs = Path.Combine(GetBasePath_CommonApplicationData(), "scncore", "scncore-rmm", "Health Agent", "Logs");
        public static string program_data_debug_txt = Path.Combine(GetBasePath_CommonApplicationData(), "scncore", "scncore-rmm", "Health Agent", "debug.txt");
        public static string program_data_server_config_json = Path.Combine(GetBasePath_CommonApplicationData(), "scncore", "scncore-rmm", "Health Agent", "server_config.json");
