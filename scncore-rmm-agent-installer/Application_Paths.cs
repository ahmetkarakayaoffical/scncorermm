...
namespace scncore_rmm_agent_installer
{
    internal class Application_Paths
    {
        ...
        public static string program_files_comm_agent_dir = Path.Combine(GetBasePath_ProgramFiles(), OperatingSystem.IsWindows() ? "0x101 Cyber Security" : "0x101_Cyber_Security", "scncore-rmm", OperatingSystem.IsWindows() ? "Comm Agent" : "Comm_Agent");
        public static string program_data_comm_agent_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent");
        public static string program_files_comm_agent_path = Path.Combine(GetBasePath_ProgramFiles(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "scncore_rmm_agent_comm.exe");
        public static string program_files_comm_agent_service_name_linux = "scncore-rmm-agent-comm";
        public static string program_files_comm_agent_service_name_osx = "com.scncore.rmm.agentcomm";
        public static string program_files_comm_agent_service_path_unix = Path.Combine(program_files_comm_agent_dir, "scncore_rmm_agent_comm");
        public static string program_files_comm_agent_service_config_path_linux = "/etc/systemd/system/scncore-rmm-agent-comm.service";
        ...
        public static string program_files_comm_agent_service_log_path_unix = "/var/log/scncore-rmm-agent-comm.log";
        
        public static string program_data_comm_agent_logs_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Logs");
        public static string program_data_comm_agent_jobs_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Jobs");
        public static string program_data_comm_agent_msdav_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Microsoft Defender Antivirus");
        public static string program_data_comm_agent_scripts_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Scripts");
        public static string program_data_comm_agent_backups_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Backups");
        public static string program_data_comm_agent_sensors_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Sensors");
        public static string program_data_comm_agent_dumps_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Dumps");
        public static string program_data_comm_agent_temp_dir = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "Temp");
        public static string program_data_comm_agent_server_config = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "server_config.json");
        public static string program_data_health_agent_server_config = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Health Agent", "server_config.json");
        public static string program_data_comm_agent_just_installed = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "just_installed.txt");

        public static string program_data_comm_agent_events_path = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "events.nlock");
        public static string program_data_comm_agent_policies_path = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "policy.nlock");
        public static string program_data_comm_agent_version_path = Path.Combine(GetBasePath_CommonApplicationData(), "0x101 Cyber Security", "scncore-rmm", "Comm Agent", "version.txt");
