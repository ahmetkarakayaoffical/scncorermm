    ...
    internal class Program
    {
        ...
        static async Task MainAsync(string[] args)
        {
            try
            {
                ...
                Console.Title = "scncore-rmm Agent Installer";
...
";
                ...
                // Create temp dir
                if (!Directory.Exists(Application_Paths.c_temp_scncore_rmm_dir))
                    Directory.CreateDirectory(Application_Paths.c_temp_scncore_rmm_dir);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + comm_package_url, Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.comm_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + remote_package_url, Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.remote_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + health_package_url, Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.health_agent_package_path), server_config_new.package_guid);
                ...
                if (OperatingSystem.IsWindows())
                {
                    http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + user_process_package_url, Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.user_process_package_path), server_config_new.package_guid);
                ...
                string comm_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.comm_agent_package_path);
                ...
                string remote_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.remote_agent_package_path);
                ...
                string health_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.health_agent_package_path);
                ...
                string user_process_package_path = Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.user_process_package_path);
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.comm_agent_package_path), Application_Paths.program_files_comm_agent_dir, true);
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.remote_agent_package_path), Application_Paths.program_files_remote_agent_dir, true);
                ...
                if (arg1 == "clean")
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.health_agent_package_path), Application_Paths.program_files_health_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_rmm_dir, Application_Paths.user_process_package_path), Application_Paths.program_files_user_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Process.Start("sc", "create scncore_rmm_agent_comm binPath= \"" + Application_Paths.program_files_comm_agent_path + "\" start= auto").WaitForExit();
                    ...
                    Process.Start("sc", "create scncore_rmm_agent_remote binPath= \"" + Application_Paths.program_files_remote_agent_path + "\" start= auto").WaitForExit();
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Process.Start("sc", "create scncore_rmm_agent_health binPath= \"" + Application_Paths.program_files_health_agent_path + "\" start= auto").WaitForExit();
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Service.Start("scncore_rmm_agent_comm");
                    ...
                    Service.Start("scncore_rmm_agent_remote");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Service.Start("scncore_rmm_agent_health");
                ...
                Helper.IO.Delete_Directory(Application_Paths.c_temp_scncore_rmm_dir);
