...
namespace NetLock_RMM_Server
{
    ...
    {
        public static string logs_dir = Path.Combine(GetBasePath(), "scncore", "scncore-rmm", "Server", "Logs");
        ...
        public static string _private_files_scncore = Path.Combine(GetCurrentDirectory(), "www", "private", "files", "scncore-rmm");
        public static string _private_files_scncore_temp = Path.Combine(GetCurrentDirectory(), "www", "private", "files", "scncore-rmm", "temp");
